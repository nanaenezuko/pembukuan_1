<?php
  ...
  $page_title = "Input Pembayaran Lainnya";
  $validate = true;
  $success = false;
  $invalid = "";
  $valid = "";
  ...
  $page_title_data = "Pembayaran Lainnya";
  $breadcumb_name = ['Pembukuan Masuk','Pembayaran Lainnya','Input'];
  $breadcumb_link = ['pembukuan_masuk','pembukuan_masuk/pembayaran_lainnya/',
  '/pembukuan_masuk/pembayaran_lainnya/input.php'];
  ...
  if (is_post_request()) {
    ...
    if ($validate) {
        pembayaran_lainnya_insert_data($anggota);
        $success = true;
    }

    if ($success) {
      redirect_to(url_for('/pembukuan_masuk/pembayaran_lainnya/create.php'));
      exit;
    }
  }
 ?>
      ...
      <div class="card rounded">
        ...
        <div class="form-page">
          <form enctype="multipart/form-data" method="post" action="<?php echo url_for('/pembukuan_masuk/pembayaran_lainnya/input.php'); ?>">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input class="form-control <?php if (isset($error['error_input_no_kwitansi'])) {
                ...
                echo $valid;
              } ?>" type="text" placeholder="Input Nomor Kwitansi" aria-label="" name="no-kwitansi" id="input_no_kwitansi" value="<?php echo $anggota['no-kwitansi']; ?>" required>
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control form-control <?php if (isset($error['error_input_uraian'])) {
                ...
                echo $valid;
              } ?>" name="uraian" placeholder="Input Uraian" id="input_uraian" style="height: 100px" required><?php echo $anggota['uraian']; ?></textarea>
            </div>
            <div class="mb-3">
              ...
              <input class="form-control <?php if (isset($error['error_input_jumlah'])) {
                ...
                echo $valid;
              } ?>" type="number" placeholder="Input Jumlah" aria-label="" name="jumlah" id="input_jumlah" value="<?php echo $anggota['jumlah']; ?>" required>
