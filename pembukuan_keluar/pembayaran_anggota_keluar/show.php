<?php
  ...
  if ($no_urut !== "") {
    $data = pembayaran_anggota_keluar_find_one($no_urut);
    if (!isset($data)) {
...
?>
            <div class="card card-wrapping" id="printArea">
              <h2 class="bg-primary print-header text-white" style="text-align: center;">PEMBAYARAN ANGGOTA KELUAR</h2>
              <hr>
              <br>
              <br>
              <table>
                ...
                <tr>
                  ...
                  <td> <h5>:</h5> </td>
                  <td> <img src="<?php echo url_for('/uploads/pembukuan_keluar/pembayaran_anggota_keluar/'.$data['no_anggota'].'/'.$data['folder'].'/'.$data['link_pembayaran_anggota_keluar']); ?>" alt="" style="height: 210px;"> </td>
                </tr>
                <tr>
                  <td> <h5>FOTO BUKTI BAYAR</h5> </td>
                  <td> <h5>:</h5> </td>
                  <td> <img src="<?php echo url_for('/uploads/pembukuan_keluar/pembayaran_anggota_keluar/'.$data['no_anggota'].'/'.$data['folder'].'/'.$data['link_bukti_bayar']); ?>" alt="" style="height: 210px;"> </td>
                </tr>
              </table>
            </div>
