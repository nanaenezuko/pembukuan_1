...
if (page_title == "Input Belanja Operasional") {

  var input_uraian_belanja = document.getElementById("input_uraian_belanja");
  ...
  input_text_validation(input_uraian_belanja);
...
if (page_title == "Belanja Operasional") {
  var active = "";
...
function click_redirect_to(){
  window.location.href = '/pembukuan/pembukuan_keluar/belanja_operasional/index.php';
}
