...
if (page_title == "Input Pembayaran Pinjaman Anggota") {

  var input_no_anggota = document.getElementById("input_no_anggota");
  var input_lama_pinjaman = document.getElementById("input_lama_pinjaman");
  var input_nama_anggota = document.getElementById("input_nama_anggota");
  var input_jumlah_pinjaman = document.getElementById("input_jumlah_pinjaman");
  ...
  input_text_validation(input_lama_pinjaman);
  input_text_validation(input_jumlah_pinjaman);
...
if (page_title == "Pembayaran Pinjaman Anggota") {
  var active = "";
...
function click_redirect_to(){
  window.location.href = '/pembukuan/pembukuan_keluar/pembayaran_pinjaman_anggota/index.php';
}
