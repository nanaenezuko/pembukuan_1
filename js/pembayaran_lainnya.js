...
if (page_title == "Input Pembayaran Lainnya") {

  var input_no_kwitansi = document.getElementById("input_no_kwitansi");
  var input_uraian = document.getElementById("input_uraian");
  var input_jumlah = document.getElementById("input_jumlah");

  input_text_validation(input_no_kwitansi);
  input_text_validation(input_uraian);
  input_text_validation(input_jumlah);
}

function getDataAnggota(no_anggota, nama_anggota){
  if (no_anggota == "") {
    nama_anggota.value = "";
    return;
  }
...
if (page_title == "Pembayaran Lainnya") {
  var active = "";
...
function click_redirect_to(){
  window.location.href = '/pembukuan/pembukuan_masuk/pembayaran_lainnya/index.php';
}
