...
if (page_title == "Input Pembayaran Anggota Keluar") {
  ...
  input_no_anggota.addEventListener("input", function(){
    ...
    getDataTotal(input_no_anggota.value, input_jumlah);
  });
...
if (page_title == "Pembayaran Anggota Keluar") {
  var active = "";
...
function click_redirect_to(){
  window.location.href = '/pembukuan/pembukuan_keluar/pembayaran_anggota_keluar/index.php';
}
