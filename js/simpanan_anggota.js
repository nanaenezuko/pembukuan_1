...
if (page_title == "Input Simpanan Anggota") {

  var input_no_anggota = document.getElementById("input_no_anggota");
  var input_simpanan_pokok = document.getElementById("input_simpanan_pokok");
  var input_simpanan_wajib = document.getElementById("input_simpanan_wajib");
  var input_simpanan_sukarela = document.getElementById("input_simpanan_sukarela");
  ...
  input_text_validation(input_simpanan_pokok);
  input_text_validation(input_simpanan_wajib);
  input_text_validation(input_simpanan_sukarela);
}
...
if (page_title == "Simpanan Anggota") {
  var active = "";
...
function click_redirect_to(){
  window.location.href = '/pembukuan/pembukuan_masuk/simpanan_anggota/index.php';
}
